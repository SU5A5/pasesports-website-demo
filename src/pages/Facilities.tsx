...
const FACILITIES = [
  { id: 1, name: 'Court A — Tennis', sport: 'Tennis', surface: 'Hard Court', lighting: 'LED Floodlights', live: true, price: 800, img: `${import.meta.env.BASE_URL}tennis.jpg` },
  { id: 2, name: 'Court B — Tennis', sport: 'Tennis', surface: 'Hard Court', lighting: 'LED Floodlights', live: false, price: 800, img: `${import.meta.env.BASE_URL}tennis.jpg` },
  ...
  { id: 4, name: 'Hall 1 — Badminton', sport: 'Badminton', surface: 'Wooden', lighting: 'Indoor LED', live: true, price: 500, img: `${import.meta.env.BASE_URL}badminton.avif` },
